 ...
 * 
 * @param {Array} items - 기상청 API 응답 배열 (각 항목: { fcstDate, fcstTime, category, fcstValue })
 * @returns {Array} 날짜+시간별로 그룹화되고 시간순 정렬된 예보 배열
 * 
 * 예시 입력:
 * [
 *   { fcstDate: "20260129", fcstTime: "1500", category: "TMP", fcstValue: "5" },
 *   { fcstDate: "20260129", fcstTime: "1500", category: "SKY", fcstValue: "1" }
 * ]
 * 
 * 예시 출력:
 * [
 *   { fcstDate: "20260129", fcstTime: "1500", TMP: "5", SKY: "1" }
 * ]
 */
export function groupForecastItems(items) {
  ...
  items.forEach((item) => {
    ...
    // 예보 항목(category)을 속성으로 추가 (예: TMP, SKY, POP 등)
 ...
 * 
 * @param {Array} groupedItems - groupForecastItems 함수로 그룹화된 예보 배열
 * @returns {Object | undefined} 현재 시간 이후 첫 번째 예보 객체
 */
